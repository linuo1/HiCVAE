...
class cVAE_Model_4(nn.Module):
    ...
    def __init__(self, p_dims, q_dims, q_dims_att, q_dims_adj, dropout=0.5):
        ...
        self.dense_input = nn.Linear(self.p_dims[0], self.p_dims[0] * 2)
    ...
    def forward(self, input_x_huai, input_att, input_adj, input_x_all):
        ...
        real_mu, real_logvar = self.encode_2(input_x_all, att_z) # 等价于 同adj共享参数
